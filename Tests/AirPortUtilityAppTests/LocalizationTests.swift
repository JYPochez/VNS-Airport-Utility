...
final class LocalizationTests: XCTestCase {
  ...
  private static let identicalByDesign: [String: Set<String>] = [
    "fr": [
      "15 minutes", "30 minutes", "AirPlay", "AirPort Express", "AirPort Extreme", "Description", "Destination", "Double NAT", "Internet", "Local", "Services", "Time Capsule", "Tunnel", "Type", "Zoom", "minute", "version",
    ],
    "de": [
      "Accounts:", "AirPlay", "AirPort Express", "AirPort Extreme", "Firmware", "Generation:", "Host", "Host:", "Hostname:", "Internet", "Name", "Name:", "Region", "Region:", "Repo", "Repository", "Repository:", "Router", "SMART: %@", "Time Capsule", "Tunnel", "Version:",
    ],
    "es": [
      "AirPlay", "AirPort Express", "AirPort Extreme", "Firmware", "Host", "Host:", "Internet", "Local", "Repo", "Router", "SMART: %@", "Time Capsule", "Zoom",
    ],
    "it": [
      "AirPlay", "AirPort Express", "AirPort Extreme", "Default", "Firmware", "Host", "Host:", "Internet", "Password", "Password:", "Repo", "Repository", "Repository:", "Router", "SMART: %@", "Time Capsule", "Tunnel", "Wireless", "Zoom",
    ],
  ]
